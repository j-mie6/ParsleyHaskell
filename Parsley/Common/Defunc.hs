...
genDefunc :: PositionOps o => Defunc q o a -> Code a
genDefunc (USER x) = genDefuncUser x
genDefunc SAME     = same

genDefunc1 :: PositionOps o => Defunc q o (a -> b) -> Code a -> Code b
genDefunc1 (USER f) qx = genDefuncUser1 f qx
genDefunc1 f qx        = [|| $$(genDefunc f) $$qx ||]

genDefunc2 :: PositionOps o => Defunc q o (a -> b -> c) -> Code a -> Code b -> Code c
