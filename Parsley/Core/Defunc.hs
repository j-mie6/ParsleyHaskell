...
genDefunc CONST           = [|| \x y -> x ||]
genDefunc FLIP_CONST      = [|| \x y -> y ||]
...
genDefunc1 CONST           qx = [|| \y -> $$qx ||]
genDefunc1 FLIP_CONST      qx = genDefunc ID
...
genDefunc2 CONST      qx qy  = qx
genDefunc2 FLIP_CONST qx qy  = qy
