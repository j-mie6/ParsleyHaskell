...
manyTestParsley = {-}$$(Parsley.runParser (Parsley.chainl1 Parsley.digit Parsley.plus))--}$$(Parsley.runParser (Parsley.skipMany (Parsley.try Parsley.item Parsley.<|> Parsley.item)))
