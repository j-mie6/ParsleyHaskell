...
manyTestParsley = {-$$(Parsley.runParser (Parsley.char 'a' Parsley.*> Parsley.satisfy (Parsley.WQ Parsley.abc [|| Parsley.abc ||])))--} $$(Parsley.runParser (Parsley.many (Parsley.char 'a')))
