...
@since 1.5.0.0
-}
coinsNeeded :: Fix4 (Instr o) xs n m r -> Coins
...
@since 1.7.2.0
-}
reclaimable :: Fix4 (Instr o) xs n m r -> Coins
...
alg :: Bool -> Instr o (Const4 (Coins, Bool)) xs n m r -> (Coins, Bool)
...
alg _     Fail{}                                  = (zero, True)
alg _     Raise                                   = (zero, True)
alg _     (RelabelError _ k)                      = getConst4 k
alg _     (RelabelGhosts _ k)                     = getConst4 k
alg _     (Explain _ k)                           = getConst4 k
alg _     (Amend k)                               = getConst4 k
alg _     (Entrench k)                            = getConst4 k
alg _     (MergeErrors k)                         = getConst4 k
alg _     (PopError k)                            = getConst4 k
alg _     (ErrorToGhost k)                        = getConst4 k
alg _     (SaveGhosts _ k)                        = getConst4 k
alg _     (PopGhosts k)                           = getConst4 k
alg _     (MergeGhosts k)                         = getConst4 k
...
algHandler :: Handler o (Const4 (Coins, Bool)) xs n m r -> (Coins, Bool)
