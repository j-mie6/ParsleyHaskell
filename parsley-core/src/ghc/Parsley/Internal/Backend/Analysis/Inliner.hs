...
alg Fail{}              = 0
alg Raise               = 0
alg (RelabelError _ k)  = 0 + getWeight k
alg (RelabelGhosts _ k) = 0 + getWeight k
alg (Explain _ k)       = 0 + getWeight k
alg (Amend k)           = 0 + getWeight k
alg (Entrench k)        = 0 + getWeight k
alg (MergeErrors k)     = 0 + getWeight k
alg (PopError k)        = 0 + getWeight k
alg (ErrorToGhost k)    = 0 + getWeight k
alg (SaveGhosts _ k)    = 0 + getWeight k
alg (PopGhosts k)       = 0 + getWeight k
alg (MergeGhosts k)     = 0 + getWeight k
