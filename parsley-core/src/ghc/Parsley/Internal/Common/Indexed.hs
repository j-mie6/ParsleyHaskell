...
class IFunctor4 (f :: ([Type] -> Nat -> Nat -> Type -> Type) -> [Type] -> Nat -> Nat -> Type -> Type) where
  imap4 :: (forall i' j' k' l'. a i' j' k' l' -> b i' j' k' l') -> f a i j k l -> f b i j k l
...
cata4 :: forall f a i j k l. IFunctor4 f =>
         (forall i' j' k' l'. f a i' j' k' l' -> a i' j' k' l') ->
         Fix4 f i j k l -> a i j k l
cata4 alg = go where
  go :: Fix4 f i' j' k' l' -> a i' j' k' l'
