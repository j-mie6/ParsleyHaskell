...
import Parsley.Internal.Backend.Machine.InputOps (PositionOps(same), BoxOps(box))
...
data Defunc a where
  ...
  BOTTOM  :: Defunc a
  SAME    :: (PositionOps o, BoxOps o) => Defunc (o -> o -> Bool)
...
ap2 f@SAME (OFFSET o1) (OFFSET o2) = USER (black (apSame f o1 o2))
  where
    ...
    apSame SAME o1 o2 = [|| $$same $$(box @o o1) $$(box @o o2) ||]
    apSame _ _ _ = undefined
